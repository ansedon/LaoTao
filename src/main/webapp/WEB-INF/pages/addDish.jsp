                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-4 col-sm-offset-1">
                                            <div class="picture-container">
                                                <div class="picture">
                                                    <img src="assets/images/defaultdish.jpeg" class="picture-src" id="wizardPicturePreview" title=""/>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input name="dishname" type="text" class="form-control" placeholder="- 不超过16个汉字 -">
                                            </div>
                                            <div class="form-group">
                                                <label>菜品价格 <small> </small></label>
                                                <input name="dishprice" type="number" class="form-control" placeholder="- 货币单位￥ -">
                                            </div>
                                        </div>
